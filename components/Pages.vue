  ...
  <div class="wrap">
    ...
    <div class="bottom_part">
      ...
      <div class="edu">
        ...
        <span>{{college_degree}} {{college_school}}</span>
      </div>
      <div ></div>
  ...
  export default {
    ...
    data: () => {
      ...
      return {
        ...
        // hope: `期望薪资 ${salary}  正常交金 如果是猎头请周六日和晚上安排面试吧 白天事情多..没法请假 ,要是每个都请假那现在也没法上班了...或者能否对方公司技术能先电话面试下。。在去实地面试，以节省双方时间`,
        name: '贺贤明',
        email: 'gakaki@qq.com',
        qq: '82506111',
        portrait: 'avatar.jpg',
        ...
        year: `84年 天蝎座`,
        college_degree: `本科`,
        college_school: `上海交通大学-计算机科学与技术`,
        college_end_time: `06年7月`,
        work_experience_year: `13年`,
        phone: `13621822254`,
        ...
        target: {
          // '期望工作': '技术负责人,iOS,Golang,Node全栈,前端开发,大数据',
          // '期望薪资': `${salary}`,
          // '其他': '周六日双休'
        },
        poweredBy: {
        ...
        job_history: [
          {
            ...
            job_title: '全栈工程师',
            job_desc: [
              // `OKR （目标和关键成果）系统的后端研发工作。公司全体员工3000人共同使用，能够承载瞬时高峰高并发请求。 内含 OKR管理，对齐关系，通知，权限管理，统计分析 等复杂企业级管理模块`,
              ...
              `参与项目：移动端发版管理系统研发，开发了包管理（迭代、热修复、h5离线包），流程打包系统，以及 Android组件包管理系统（组件列表，依赖管理、依赖审核、依赖同步）`
            ]
          },
          {
